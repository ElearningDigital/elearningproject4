sap.ui.define([
	...
	return Opa5.extend("nsproject4.project4.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["nsproject4/project4/localService/mockserver"], function (mockserver) {
